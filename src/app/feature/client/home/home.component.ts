...
export class HomeComponent implements AfterViewInit {
  ...
  loadProvinceData() {
    this.homeService.getProgramCountPerProvinsi(this.filter)
      .subscribe({
        next: (res: any) => {
  ...
  getOptionFilter() {
    this.homeService.getOptionFilter().subscribe({
      next: (res: any) => {
  ...
  getDataSummary() {
    this.homeService.getDataSummary(this.filter).subscribe({
      next: (res: any) => {
